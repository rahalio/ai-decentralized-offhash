/**
 * Antipatterns Services - Application Layer Export
 *
...
/**
 * Antipatterns Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for antipatterns domain.
 */
