 ...
 *
 * @returns The core table name (e.g., "offhash-core-dev")
 ...
 *
 * @returns The base table name (e.g., "offhash-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "offhash-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "offhash-app-realtime-dev")
