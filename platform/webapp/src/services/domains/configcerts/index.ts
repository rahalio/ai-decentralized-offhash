 ...
 * Configcerts Domain
 *
 * Barrel export for configcerts service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { configcertsService } from './configcerts.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { configcertsFacade } from './facade';
