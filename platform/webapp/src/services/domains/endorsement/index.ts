 ...
 * Endorsement Domain
 *
 * Barrel export for endorsement service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { endorsementService } from './endorsement.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { endorsementFacade } from './facade';
