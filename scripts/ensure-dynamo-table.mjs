 ...
 * Usage: TABLE_NAME=offhash-core-local AWS_ENDPOINT_URL=http://localhost:8000 node scripts/ensure-dynamo-table.mjs
 */
...
async function main() {
  process.env.TABLE_NAME =
    process.env.TABLE_NAME || 'offhash-core-local';
